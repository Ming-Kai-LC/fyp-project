...
# # 07 - ResNet-50 Training (Phase 2)
# 
# **Author:** Tan Ming Kai (24PMR12003)  
# **Date:** 2025-11-12  
# **Purpose:** Train ResNet-50 baseline with 5 random seeds
# 
# **Model:** ResNet-50 (25.6M parameters, CNN baseline)
# 
# ---
# 
# ## Objectives
# 1. Train ResNet-50 with seeds: 42, 123, 456, 789, 101112
# 2. Log all runs to MLflow
# 3. Calculate mean ± std accuracy
# 4. Compare against CrossViT in Phase 3
# 
# ---
# 
# **Note:** This notebook follows the same structure as 06_crossvit_training.ipynb but uses ResNet-50 model.
...
CONFIG = {
    ...
    'batch_size': 24,  # ResNet can handle larger batches
    'num_workers': 0,
    'learning_rate': 1e-4,
    'weight_decay': 1e-4,
    'max_epochs': 30,
...
def train_resnet_single_seed(seed, config):
    ...
    print(f"[OK] ResNet-50 loaded: {sum(p.numel() for p in model.parameters()):,} parameters")
...
for seed in CONFIG['seeds']:
    try:
        ...
        print(f"[ERROR] Error with seed {seed}: {e}")
        continue
...
print(f"\n[STATS] ResNet-50 Results (5 seeds):")
